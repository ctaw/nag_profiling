...
(function ($) {
    ...
    tl.pg.default_prefs = {
        ...
        'track_events_cb': function() { 
          ...
          $('#inner-wrapper').css("z-index",60);

          
          $('body').css("overflow","hidden");
          
          //$('.wrapper_hack').addClass("z-index-99").addClass("overflow-hidden");

         },
        'handle_doc_switch': null,
        'custom_open_button': "#page-help-bind",
        'pg_caption' : 'Page Instructions',
    ...
    tl.pg.PageGuide.prototype.setup_handlers = function () {
        ...
        $('.tlypageguide_close', self.$message.add($('.tlypageguide_toggle')))
            .on('click', function() {
                ...
                $('#sidebar-wrapper').css("z-index",9999);
                $('#inner-wrapper').css("z-index",0);
                $('body').css("overflow","auto");
                $('.play-btn').tooltip();
                //$('.wrapper_hack').removeClass("z-index-99").removeClass("overflow-hidden");
                
                if($('.example-template').length > 0){
                  $('.questions-module').removeClass("hidden")
                  $('.example-template').addClass("hidden")
                }
              return false;
        });
